...
using CanadaSoftware.ApiDotNet.Commom.AddressProperties;
using CanadaSoftware.ApiDotNet.Commom.BankDataProperties;
using CanadaSoftware.ApiDotNet.Commom.ClientProperties;
using CanadaSoftware.ApiDotNet.Commom.DocumentProperties;
